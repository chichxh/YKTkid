...
if(isset($_POST['signupKid']))
{
    ...
    if(count($err) == 0)
    {
        $query = "INSERT INTO kids (name, surname, patronymic, email, tel, age, school, clas, aboutme, password) VALUES ('". $_POST['name'] ."', '". $_POST['surname'] ."', '". $_POST['patronymic'] ."', '". $_POST['email'] ."', '". $_POST['tel'] ."', '". $_POST['age'] ."', '". $_POST['school'] ."', '". $_POST['clas'] ."', '". $_POST['aboutme'] ."', '". $_POST['password'] ."')";
		...
		<div class="row mt-5">
			<div class="col-6">
				<div class="text-center mt-5">
					...
					<p>Уже есть аккаунт?  <a href="signin.php">Войдите</a></p>
				</div>
